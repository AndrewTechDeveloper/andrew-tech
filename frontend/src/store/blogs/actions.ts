...
export const changeEditorState = (editorState: EditorState) =>
  action(BlogsActionTypes.CHANGE_EDITOR_STATE, editorState)
export const changeTitle = (event: React.ChangeEvent<HTMLInputElement>) =>
  action(BlogsActionTypes.CHANGE_TITLE, event.target.value)
...
export const changeOgImage = (event: React.ChangeEvent<HTMLInputElement>) =>
  action(BlogsActionTypes.CHANGE_OG_IMAGE, event.target.value)
...
export const deleteToast = () =>
  action(BlogsActionTypes.DELETE_TOAST)
export const fetchSuccess = (data: BlogsState) =>
  action(BlogsActionTypes.FETCH_SUCCESS, data)
export const fetchAllSuccess = (data: Blog[]) =>
  action(BlogsActionTypes.FETCH_ALL_SUCCESS, data)

export const fetchRequest = () =>
  action(BlogsActionTypes.FETCH_REQUEST)
export const fetchAllRequest = () =>
  action(BlogsActionTypes.FETCH_ALL_REQUEST)
export const saveRequest = () =>
  action(BlogsActionTypes.SAVE_REQUEST)
