...
export const changeInlineStyleRequest = () => action(BlogsActionTypes.CHANGE_INLINE_STYLE_REQUEST)
export const changeBlockTypeRequest = () => action(BlogsActionTypes.CHANGE_BLOCK_TYPE_REQUEST)
export const insertImageRequest = () => action(BlogsActionTypes.INSERT_IMAGE_REQUEST)
